...
int covers(const Node<T> *cr, const Node<T> *p, const Node<T> *q) {
    ...
    if ((result += covers(cr->left, p, q)) == TWO) {
        return result;
    }
    else {
        return result + covers(cr->right, p, q);
    }
}
...
Node<T> *common(Node<T> *cr, const Node<T> *p, const Node<T> *q) {
    ...
    if (cr->left) {
        ...
        if (l_cnt == TWO) {
            ...
            if (cr->left == p || cr->left == q) {
                return cr->left;
            }

            // trace down, otherwise
            else {
                return common(cr->left, p, q);
            }
    ...
    if (cr->right) {
        ...
        if (r_cnt == TWO) {
            ...
            if (cr->right == p || cr->right == q) {
                return cr->right;
            }

            // trace down, otherwise
            else {
                return common(cr->right, p, q);
            }
